...
df = pd.read_csv('D:\\sjbit\\python\\randomForestData1.csv')  # Replace 'your_data.csv' with your actual CSV file name
...
forest_classifier = joblib.load("D:\\sjbit\\python\\fClassifier.joblib")
